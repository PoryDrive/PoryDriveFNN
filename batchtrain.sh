# python3 train.py 4 384 32 adam 1
# python3 train.py 4 768 64 adam 1
# python3 train.py 4 2048 64 adam 0

# python3 train.py 4 384 32 sgd 1
# python3 train.py 4 768 64 sgd 1
# python3 train.py 4 2048 64 sgd 0

# python3 train.py 4 384 32 momentum 1
# python3 train.py 4 768 64 momentum 1
# python3 train.py 4 2048 64 momentum 0

# python3 train.py 4 384 32 nesterov 1
# python3 train.py 4 768 64 nesterov 1
# python3 train.py 4 2048 64 nesterov 0

# python3 train.py 4 384 32 nadam 1
# python3 train.py 4 768 64 nadam 1
# python3 train.py 4 2048 64 nadam 0

# python3 train.py 4 384 32 adagrad 1
